...
type SignupAction = { type: "signup" | "success" | "error" } | { type: "field"; fieldName: string; payload: string };
    ...
    <>
      <div className="signup_form">
        <div>
          ...
          <h4 className="sub-title">Please fill in this form to create an account.</h4>
